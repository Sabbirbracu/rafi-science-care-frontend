        ...
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-5">
            <div className="relative mx-auto max-w-sm lg:max-w-none">
              ...
              <div
                aria-hidden
                className="absolute -inset-4 rounded-[32px] bg-gradient-to-br from-[#1a6b3c]/10 via-[#f97316]/10 to-transparent blur-2xl"
              />

              <div className="relative overflow-hidden rounded-3xl border border-gray-100 bg-gradient-to-br from-[#ecf7f0] via-white to-[#fff7ed] p-8 shadow-xl">
                {/* Avatar placeholder */}
                <div className="mx-auto flex h-40 w-40 items-center justify-center rounded-full bg-gradient-to-br from-[#1a6b3c] to-[#082817] text-7xl font-bold text-white shadow-2xl shadow-[#1a6b3c]/30 sm:h-48 sm:w-48">
                  R
                </div>
                ...
                <div className="mt-6 text-center">
                  ...
                  <p className="mt-1 font-sans text-sm font-semibold text-[#f97316]">
                ...
                <div className="mt-6 grid grid-cols-3 gap-2 border-t border-gray-100 pt-6">
                  {STATS.map((stat) => (
                    <div key={stat.label} className="text-center">
                      <p className="font-sans text-lg font-bold text-[#114829] sm:text-xl">
                        {stat.value}
                      </p>
          ...
          <div className="lg:col-span-7">
            ...
            <h2 className="mt-3 text-3xl font-bold leading-tight text-gray-900 sm:text-4xl md:text-5xl">
              কে পড়াবেন{" "}
              <span className="text-[#1a6b3c]">তোমাকে?</span>
            </h2>
            ...
            <div className="mt-6 space-y-4 text-base leading-relaxed text-gray-700 sm:text-lg">
              <p>
                ...
                Doctor এবং অভিজ্ঞ Biology শিক্ষক। SSC থেকে HSC পর্যন্ত বছরের
                পর বছর ধরে হাজার হাজার Student-কে Biology-তে A+ পেতে সাহায্য
            ...
            <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-3">
              {[
                ...
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#1a6b3c]/10 text-[#1a6b3c]">
