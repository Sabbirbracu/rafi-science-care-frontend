...
export default function Solution() {
  return (
    <section
      id="solution"
      className="relative overflow-hidden bg-[#0d2240] py-20 text-white sm:py-24 lg:py-28"
    >
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,rgba(220,38,38,0.18),transparent_45%),radial-gradient(circle_at_85%_80%,rgba(30,86,136,0.5),transparent_50%)]" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3.5 py-1.5 backdrop-blur">
            <Sparkles size={14} className="text-[#fca5a5]" />
          ...
          <p className="mt-6 text-base leading-relaxed text-white/80 sm:text-lg">
            ...
            প্রতিটি গুরুত্বপূর্ণ Topic Live Class-এ পড়ানো হবে, Recorded Lecture
            থাকবে যেকোনো সময় দেখার জন্য, আর Real OMR-based Exam দিয়ে নিজেকে যাচাই
            করতে পারবে।
          </p>
        </div>
        ...
        <div className="mt-14 grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-6">
          {HIGHLIGHTS.map(({ icon: Icon, label, note }) => (
            <div
              key={label}
              className="group rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur transition hover:border-[#dc2626]/40 hover:bg-white/10"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[#dc2626] to-[#b91c1c] text-white shadow-lg">
